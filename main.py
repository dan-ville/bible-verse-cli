...
def main():
    ...
    parser.add_argument('reference', type=str, help="Bible verse reference (e.g., John 11:35)", default=None)
    ...
    if args.reference:
        ...
        verse = esv_service.get_bible_verse(args.reference, args.mode)
        print(verse)
    else:
